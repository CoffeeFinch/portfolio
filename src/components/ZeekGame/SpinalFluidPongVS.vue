...
<div class="counterHolder">
      ...
      <img class="skulman" v-if="(counters[0] <= 5)" src="assets/spinaltap/spinal0.png" />
  <img class="skulman" v-if="(counters[0] >= 10) && (counters[0] <= 19)" src="assets/spinaltap/spinal10.png" />
  <img class="skulman" v-if="(counters[0] >= 20) && (counters[0] <= 24)" src="assets/spinaltap/spinal20.png" />
  <img class="skulman" v-if="(counters[0] >= 25) && (counters[0] <= 29)" src="assets/spinaltap/spinal25.png" />
  <img class="skulman" v-if="(counters[0] >= 30) && (counters[0] <= 34)" src="assets/spinaltap/spinal30.png" />
  <img class="skulman" v-if="(counters[0] >= 35) && (counters[0] <= 39)" src="assets/spinaltap/spinal35.png" />
  <img class="skulman" v-if="(counters[0] >= 40) && (counters[0] <= 44)" src="assets/spinaltap/spinal40.png" />
  <img class="skulman" v-if="(counters[0] >= 45) && (counters[0] <= 49)" src="assets/spinaltap/spinal45.png" />
  <img class="skulman" v-if="(counters[0] >= 50) && (counters[0] <= 54)" src="assets/spinaltap/spinal50.png" />
  <img class="skulman" v-if="(counters[0] >= 55) && (counters[0] <= 59)" src="assets/spinaltap/spinal55.png" />
  <img class="skulman" v-if="(counters[0] >= 60) && (counters[0] <= 64)" src="assets/spinaltap/spinal60.png" />
  <img class="skulman" v-if="(counters[0] >= 65) && (counters[0] <= 69)" src="assets/spinaltap/spinal65.png" />
  <img class="skulman" v-if="(counters[0] >= 70) && (counters[0] <= 74)" src="assets/spinaltap/spinal70.png" />
  <img class="skulman" v-if="(counters[0] >= 75) && (counters[0] <= 79)" src="assets/spinaltap/spinal75.png" />
  <img class="skulman" v-if="(counters[0] >= 80) && (counters[0] <= 84)" src="assets/spinaltap/spinal80.png" />
  <img class="skulman" v-if="(counters[0] >= 85) && (counters[0] <= 100)" src="assets/spinaltap/spinal85.png" />
  <div class="button">
